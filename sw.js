"use strict";
const CACHE="evolva-v9-0-5";
const SHELL=["./reset-cache.html","./release.json","./","./index.html","./styles.css?v=9.0.5","./manifest.webmanifest?v=9.0.5","./icons/icon.svg","./js/main.js?v=9.0.5","./js/engine.js?v=9.0.5","./js/game.js?v=9.0.5"];
