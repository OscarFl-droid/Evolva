"use strict";
const CACHE="evolva-v10-3-1";
const SHELL=["./reset-cache.html","./release.json","./","./index.html","./styles.css?v=10.3.1","./manifest.webmanifest?v=10.3.1","./icons/icon.svg","./js/main.js?v=10.3.1","./js/engine.js?v=10.3.1","./js/game.js?v=10.3.1"];
