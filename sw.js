"use strict";
const CACHE="evolva-v8-2-2";
const SHELL=["./","./index.html","./styles.css?v=8.2.2","./manifest.webmanifest?v=8.2.2","./icons/icon.svg","./js/main.js?v=8.2.2","./js/engine.js?v=8.2.2","./js/game.js?v=8.2.2"];
