"use strict";
const CACHE="evolva-v8-0-0";
const SHELL=["./","./index.html","./styles.css?v=8.0.0","./manifest.webmanifest?v=8.0.0","./icons/icon.svg","./js/main.js?v=8.0.0","./js/engine.js","./js/game.js"];
