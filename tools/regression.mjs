...
ok(release.version==='10.3.3','release version');
ok(release.saveKey==='evolva-save-v10-3-3','save identity');
ok(manifest.name.includes('10.3.3'),'manifest identity');
ok(index.includes('10.3.3')&&sw.includes('evolva-v10-3-3'),'build/cache identity');
...
console.log(`EVOLVA 10.3.3 developmental threshold and migration regression checks passed (${n} assertions).`);
