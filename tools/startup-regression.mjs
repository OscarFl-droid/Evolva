...
const checks=[
 [html.includes('content="10.3.4"'),"HTML build metadata"],
 [html.includes('js/main.js?v=10.3.4'),"HTML module version"],
 [html.includes('styles.css?v=10.3.4'),"HTML stylesheet version"],
 [main.includes('./game.js?v=10.3.4'),"main/game version coherence"],
 ...
 [game.includes('LEGACY_SAVE_KEY="evolva-save-v10-3-3"')&&game.includes('"evolva-save-v10-3-2"')&&game.includes('"evolva-save-v10-3-1"'),"v10.3.3 through v10.3.1 save migration"],
 ...
 [release.version==="10.3.4"&&release.saveSchema===5,"release metadata"]
];
